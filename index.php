...
?>
    <div class="container-fluid">
        ...
        <?php if($show_modal):?> <script type="text/javascript"> $(document).ready(function() {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-12">
                    <div class="inner">
                        ...
                        <h2>Dashboard</h2><?php } else { ?>

                        <h2>Startseite</h2><? } ?>
                        <hr>
                    </div>
                </div>
            </div><?php if ($user->is_logged_in())  { ?>
                    ...
                    <div class="inner">
                        ...
                        <div id="index_pics">
                            <?php
                              ...
                              echo '<a href="'.$value->orig_path.'" title="'.$value->title.'" data-description="'.$value->description.'" data-gallery="#blueimp-gallery-ownpics"><img src="'.$value->thumb_path.'" class="img_abstand" alt="'.$value->description.'" /></a>';
